...
int main()
{
    ...
    std::vector<float> bias_mat_1, bias_mat_2, input_mat, output_mat;
    std::vector<float*> bias_mat_mem_adds_1, bias_mat_mem_adds_2, input_mat_mem_adds, output_mat_mem_adds;
